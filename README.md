...
現在のデザインは、情報量を抑え、余白・写真・文字組みで見せるブランドサイト寄りの構成です。Hero、FOUR ELEMENTS、ACTIVITIESはカード型ではなく、写真と短い言葉が流れる編集的レイアウトへ調整しています。
スクロール時には、写真・見出し・本文が少しずつ立ち上がるようにし、Heroの重なり写真には控えめな奥行きとパララックス風の動きを加えています。
文字まわりは、見出しに Zen Kaku Gothic New、本文に Noto Sans JP を優先し、細いウェイト、広い行間、詩的な改行で静かな印象に整えています。
...
- `app/globals.css`：余白、背景、あわじ結び風の線、4色表現、スクロール時の軽いフェードイン、写真のゆるやかなズーム、レスポンシブ調整
